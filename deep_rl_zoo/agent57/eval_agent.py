...
def main(argv):
    ...
    if FLAGS.environment_name in gym_env.CLASSIC_ENV_NAMES:
        ...
        ext_q_network = NguDqnMlpNet(state_dim=state_dim, action_dim=action_dim, num_policies=FLAGS.num_policies)
        int_q_network = NguDqnMlpNet(state_dim=state_dim, action_dim=action_dim, num_policies=FLAGS.num_policies)
        ...
        action_dim = eval_env.action_space.n
        ext_q_network = NguDqnConvNet(state_dim=state_dim, action_dim=action_dim, num_policies=FLAGS.num_policies)
        int_q_network = NguDqnConvNet(state_dim=state_dim, action_dim=action_dim, num_policies=FLAGS.num_policies)
