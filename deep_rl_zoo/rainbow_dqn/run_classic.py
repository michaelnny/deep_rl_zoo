...
from deep_rl_zoo.rainbow_dqn import agent
...
flags.DEFINE_string('results_csv_path', 'logs/rainbow_dqn_classic_results.csv', 'Path for CSV log file.')
flags.DEFINE_string('checkpoint_path', 'checkpoints/rainbow_dqn', 'Path for checkpoint directory.')
