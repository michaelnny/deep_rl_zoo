...
# ==============================================================================
"""A DRQN agent training on classic games like CartPole, MountainCar, or LunarLander.
...
from deep_rl_zoo.networks.dqn import DrqnMlpNet
...
flags.DEFINE_string('checkpoint_path', 'checkpoints/drqn', 'Path for checkpoint directory.')


def main(argv):
    """Trains DRQN agent on classic games."""
    del argv
    ...
    def environment_builder(random_int=0):
        return gym_env.create_classic_environment(
            env_name=FLAGS.environment_name, obscure_epsilon=FLAGS.obscure_epsilon, seed=FLAGS.seed + int(random_int)
        )
