...
# ==============================================================================
"""A QR-DQN agent training on classic games like CartPole, MountainCar, or LunarLander.
...
from deep_rl_zoo.networks.dqn import QRDqnMlpNet
...
def main(argv):
    """Trains QR-DQN agent on classic games."""
    del argv
    ...
    network = QRDqnMlpNet(input_shape=input_shape, num_actions=num_actions, quantiles=quantiles)
    ...
    assert q_dist.shape == (1, FLAGS.num_quantiles, num_actions)
