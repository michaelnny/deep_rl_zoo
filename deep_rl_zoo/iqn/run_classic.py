...
# ==============================================================================
"""An IQN agent training on classic games like CartPole, MountainCar, or LunarLander.
...
from deep_rl_zoo.networks.dqn import IqnMlpNet
...
flags.DEFINE_integer('tau_samples_policy', 32, 'Number of samples to pull from the network when choose actions.')
...
def main(argv):
    """Trains IQN agent on classic games."""
    del argv
